...
import com.ibelm.quicklteforce4g.test.HttpDownloadTest;
import com.ibelm.quicklteforce4g.test.HttpUploadTest;
import com.ibelm.quicklteforce4g.test.PingTest;
...
public class SpeedTestActivity extends AppCompatActivity {
    ...
    TextView open_browser_speedTest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        open_browser_speedTest = findViewById(R.id.open_browser_speedTest);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        open_browser_speedTest.setVisibility(View.VISIBLE);
                                    }
                                },1000);
                            }
                        });
        ...
        open_browser_speedTest.setPaintFlags(open_browser_speedTest.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        open_browser_speedTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.speedtest.net/")));
            }
        });
